...
auth.configs:
  ...
  properties:
    ...
    adminUsername: admin
    adminPassword: admin
    kmDcrUrl: https://wso2am-pattern-1-am-service:9443/client-registration/v0.15/register
    kmTokenUrlForRedirection: https://{{ .Release.Name }}-am/oauth2
    ...
    cacheTimeout: 900
    baseUrl: https://{{ .Release.Name }}-analytics-dashboard
    grantType: authorization_code
    publisherUrl: https://wso2am-pattern-1-am-service:9443
    externalLogoutUrl: https://{{ .Release.Name }}-am/oidc/logout
